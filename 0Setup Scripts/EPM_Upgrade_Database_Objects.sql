...
GO
IF EXISTS(SELECT * FROM sys.stats WHERE object_id = OBJECT_ID(N'[policy].[EvaluationErrorHistory]') AND name = 'Stat_ErrorHistoryID_EvaluatedServer_EvaluationDateTime_EvaluatedPolicy')
DROP STATISTICS policy.[EvaluationErrorHistory].[Stat_ErrorHistoryID_EvaluatedServer_EvaluationDateTime_EvaluatedPolicy]
GO
...
DROP STATISTICS policy.[EvaluationErrorHistory].[Stat_CategoryName_EvaluatedPolicy_EvaluationDateTime]
GO
IF EXISTS(SELECT * FROM sys.stats WHERE object_id = OBJECT_ID(N'[policy].[EvaluationErrorHistory]') AND name = 'Stat_ErrorHistoryID_EvaluatedServer_EvaluationDateTime')
DROP STATISTICS policy.[EvaluationErrorHistory].[Stat_ErrorHistoryID_EvaluatedServer_EvaluationDateTime]
GO
...
DROP STATISTICS policy.[EvaluationErrorHistory].[Stat_CategoryName_EvaluatedPolicy_EvaluationDateTime]
GO
IF EXISTS(SELECT * FROM sys.stats WHERE object_id = OBJECT_ID(N'[policy].[EvaluationErrorHistory]') AND name = 'Stat_ErrorHistoryID_EvaluatedPolicy_EvaluatedServer_EvaluationDateTime' )
DROP STATISTICS policy.[EvaluationErrorHistory].[Stat_ErrorHistoryID_EvaluatedPolicy_EvaluatedServer_EvaluationDateTime]
GO
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE parent_object_id = OBJECT_ID(N'[policy].[PolicyHistoryDetail]') AND [name] = 'FK_PolicyHistoryDetail_PolicyHistory')
...
USE $(ManagementDatabase)
GO
IF EXISTS(SELECT * FROM sys.objects WHERE name = 'pfn_ServerGroupInstances' AND type = 'IF')
